...
class StoryList {
  ...
  static async getStories() {
    ...
    // Instance method would call on an instance in a class.
    // Static method would call directly on the class.
    ...
    // map() method creates a new array from the results of a funcion.
  ...
  async addStory(user, {title, author, url}) {
    ...
    // unshift() method adds elements to 
    // the beginning of an array and returns a new array 
  ...
  // axios is a promise-based method that waits to be used 
  // unil called upon
...
class User {
  ...
  static async signup(username, password, name) {
    const response = await axios({
      url: `${BASE_URL}/signup`,
      method: "POST",
      // information user puts in themselves, so axios is retrieving information 
      data: { user: { username, password, name } },
    });

    // created a variable that stores the info the user put in  
